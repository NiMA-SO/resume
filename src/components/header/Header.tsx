...
const Header = () => {
  ...
  return (
    <header className="col-span-6 flex justify-between px-16 items-center self-start md:col-span-12 sticky top-0 h-[10vh] bg-[#ffffff] shadow-[0_4px_12px_rgba(0,0,0,0.1)] dark:shadow-[0_4px_12px_rgba(255,255,255,0.05)]">
      <div className="w-[300px] flex justify-between items-center ">
        <img src={logo} className="h-[70px]" alt="" />
      <h1 className="font-bold -tracking-tighter text-[25px]">NiMA SOHRABI</h1>
      </div>
        <span className="font-semibold -tracking-tighter text-[16px]">
          Front-End Developer
        </span>
